package com.odogwudev.webtoapp;
...
public class Config {
    ...
    public static final Object[] TITLES = new String[]{"Odogwudev","My Github","My LinkedIn"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://odogwudev.com.ng/","https://github.com/odogwudev","https://www.linkedin.com/in/enomamichael/"};
